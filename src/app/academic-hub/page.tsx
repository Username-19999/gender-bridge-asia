...
export default function AcademicHub() {
  ...
  const researchFrontiers = [
    {
      title: t("Intersectionality, Multi-Axis Oppression & Structural Inequality", "交叉性、多重压迫与结构性不平等"),
    ...
    {
      title: t("Algorithmic Bias & Digital Governance", "算法性别歧视与数字空间治理"),
      description: t("Investigates how AI and big data encode and reinforce gender bias, and the mechanisms of technological discipline and censorship imposed by platforms on gender and sexual minorities.", "研究人工智能和大数据如何编码并强化性别偏见，以及平台对性别和性少数群体的技术规训与审查机制。"),
      color: "border-l-4 border-[#d62e39]"
    },
    {
      title: t("Economic Participation, Labor Market & Care Economy", "经济参与、劳动力市场与照护经济"),
    ...
    {
      title: t("Political Empowerment, Women's Leadership & Representation", "政治赋权、女性领导力与代表性"),
    ...
    {
      title: t("Queer Theory, Trans Politics & Anti-Normativity", "酷儿理论、跨性别政治与反规范性"),
    ...
    {
      title: t("Gender Violence, Survivor-Centered Approach & Judicial Justice", "性别暴力、幸存者中心视角与司法正义"),
    ...
    {
      title: t("Environmental Justice, Climate Crisis & Ecofeminism", "环境正义、气候危机与生态女性主义"),
    ...
    {
      title: t("Masculinity, Affective Labor & Alternative Construction", "情感劳动、毒性男性气质与替代性建构"),
    ...
    {
      title: t("Gender Impact of Global Crises & Intersectional Response", "全球危机对性别的影响与交叉性响应"),
    ...
    {
      title: t("Digital Feminism, Online Activism & Neoliberal Critique", "数字女权主义、线上行动主义与新自由主义批判"),
  ...
  const asiaResearch = [
    ...
    {
      title: t("Taiwan", "台湾"),
      subtitle: t("Queer Citizenship, Legal Innovation & Deepening Gender Equality Education", "酷儿公民权、法律制度创新与性别平等教育深化"),
    ...
    },
    {
      ...
      subtitle: t("Transnational Labor, Post-Colonial Intersectionality & Urban Gender Politics", "跨界劳工、后殖民交叉性与城市性别政治"),
    ...
    },
    {
      ...
      subtitle: t("Low Fertility Crisis, Radical Feminism & Masculinity Anxiety", "低生育危机、激进化女权与男性气质焦虑"),
    ...
    {
      title: t("Japan", "日本"),
      subtitle: t("Aging Society, Persistent Workplace Inequality & Patriarchy/Capital Critique", "老龄化社会、职场持续不平等与父权/资本批判"),
